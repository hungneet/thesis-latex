...
\input{Tables/ResponsiveTesting/ResponsiveCriteria.tex}

The testing environment used for responsive testing is as follows:
\input{Tables/ResponsiveTesting/ResponsiveEnviroment.tex}

\section{Performance testing}
For performance testing, we use Google Lighthouse to help us evaluate the general performance, accessibility, best practice, and SEO parameters of our website:
\begin{itemize}
  ...
  \item Best Practices: Check adherence to best practices for web development.
...
\input{Tables/PerformanceTest.tex}
...
\begin{itemize}
  ...
  \item Number of virtual users: \textit{50}
  \item Ramp up: \textit{from 5 users at the beginning to 50 users at the end of the duration}
\end{itemize}

Based on the non-functional requirements of the system, the expected outputs are:
\begin{itemize}
...
After doing the test, the final result is shown in \textit{Figure 6.3}. All the expected outputs are passed with the outputs are:
\begin{itemize}
