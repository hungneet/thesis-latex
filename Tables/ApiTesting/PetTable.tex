\begin{longtblr}[
    ...
    1 & \SetCell[r=3]{c}POST - /Pet & 1. Unauthorized & Error code 401 with message "Unauthorized". & Pass & \SetCell[r=3]{c}620ms \\
    ...
    \SetCell[r=3]{c}4 & \SetCell[r=3]{c}DELETE - /Pet/\{blog\_id\} & 1. Unauthorized & Error code 401 with message "Unauthorized". & Pass & \SetCell[r=3]{c}719ms \\
