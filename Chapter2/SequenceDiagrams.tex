...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Figures/self_register_seq.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Figures/update_org_seq.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Figures/payment_seq.png}
