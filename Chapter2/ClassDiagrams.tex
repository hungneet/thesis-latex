...
The system design is proposed to adhere to the Layered and Repository
design patterns as outlined in \emph{\textbf{section 2.6}}.
Consequently, the system's classes are categorized into four distinct
groups.

\emph{View Classes (Figure 2.21)}: These classes encompass the user
...
\emph{Service Classes (Figure 2.22)}: These classes contain methods for
...
\emph{DataLayer Classes (Figure 2.23)}: Each class corresponds to a system
...
\emph{UnitOfWork Class (Figure 2.23)}: This singular class contains
